...
As a consultant based in the San Francisco Bay Area, I use open-source libraries from 
the [Scientific Python](https://scientific-python.org/) ecosystem to build 
production-grade solutions for my clients. Over time, I've developed specialisations 
in Machine Learning, Deep Learning, Predictive Data Analysis, Natural Language 
